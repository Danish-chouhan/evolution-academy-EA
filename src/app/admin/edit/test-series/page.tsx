...
export default function AdminEditTestSeriesPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/admin/content?page=test-series')
      .then(res => res.json())
      .then(data => {
  ...
  return (
    <ContentProvider initialContent={content} page="test-series" isAdmin={true}>
      ...
      <div className="min-h-screen flex flex-col bg-gray-50 font-sans mt-10">
        <Navbar />
