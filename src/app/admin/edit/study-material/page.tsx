...
export default function AdminEditStudyMaterialPage() {
  ...
  useEffect(() => {
    ...
    // Fetch content
    fetch('/api/admin/content?page=study-material')
      .then(res => res.json())
      .then(data => {
  ...
  return (
    <ContentProvider initialContent={content} page="study-material" isAdmin={true}>
