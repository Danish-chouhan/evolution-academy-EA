    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-center text-brand-dark mb-8">
          Login <span className="text-brand-purple">Karo</span>
        </h2>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            Abhi account nahi hai?{' '}
            <Link href={`/auth/register?redirect=${encodeURIComponent(redirectPath)}`} className="text-brand-purple hover:underline font-semibold">
              Register Karo
            </Link>
          </p>
        </div>
